			...
			<div class="box-body">
				<div class="row">
					<div class="col-md-12">
						<div class="col-md-2">
							<div class="form-group">
								...
								<input type="text" name="sales_no" id="sales_no" class="form-control"disabled value="<?php if (count($sales) > 0) : echo $sales['sales_no']; else : echo $sales_no; endif; ?>">
							</div>
						</div>
						<div class="col-md-2">
							<div class="form-group">
						...
						<div class="col-md-4">
							<div class="form-group">
								...
								<select name="customer_id" id="customer_id" class="form-control select2 col-md-6" data-placeholder="Select Customer">
									<option value=""></option>
						...
						<div class="col-md-4">
							<div class="form-group">
								...
								<textarea name="notes" id="notes" rows="1" class="form-control" placeholder="Notes"><?php if (count($sales) > 0) : echo $sales['notes']; endif; ?></textarea>
							</div>
						</div>
					</div>
					<!-- <div class="col-md-12">
					...
					<div class="col-md-12">
						<div class="col-md-3">
							<div class="form-group">
								<label for="item_id">Select Item <span style="color:red">*</span></label>
								<select name="item_id" id="item_id" class="form-control change-price select2" data-placeholder="Select Item">
									<option></option>
						...
						<div class="col-md-3">
							<div class="form-group">
								<label for="ab_quantity">Stock</label>
								<input type="text" name="ab_quantity" id="ab_quantity" class="form-control" disabled placeholder="Stock">
							</div>
						</div>
						<div class="col-md-3">
							<div class="form-group">
								<label for="quantity">Quantity <span style="color:red">*</span></label>
								<input type="text" name="quantity" id="quantity" class="form-control" onkeyup="validateNumber()">
								<div id="demo" class="hide">
									<span style="color:red">Note: *</span><p>Please Type More than 0 Number</p>
								</div>
							</div>
						</div>
						<div class="col-md-3">
							<div class="form-group">
								...
								<input type="text" name="price" id="price" class="form-control" placeholder="Keep Blank for Default Price" onkeyup="validatePrice()">
								<div id="priceDiv" class="hide">
									<span style="color:red">Note: *</span><p>Please Type More than 0 Number</p>
								</div>
							</div>
						</div>
	...
	<div class="box box-primary">
		...
		<div class="box-body" id="sales_details">
			<table id="sales_details_table" class="table table-bordered table-striped">
				...
				<tr>
					<td colspan="4" class="right">Delivery Charge</td>
					<td><input type="text" name="DeliveryCharge" id="DeliveryCharge" value="<?php echo number_format($price, 2); ?>"></td>
					<td></td>
				</tr>
				<tr>
...
<script>
	...
	// $('#quantity').on('input', function() {
			// 	var input=$(this);
			// 	var re = /^[1-9]*$/;
			// 	var valid_number=re.test(input.val());
			// 	if(valid_number){input.removeClass("invalid").addClass("valid");}
