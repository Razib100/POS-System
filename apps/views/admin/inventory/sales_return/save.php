					...
					<div class="col-md-12">
						<div class="col-md-3">
							<div class="form-group">
								...
								<input type="text" readonly name="sales_return_no" id="sales_return_no" class="form-control" value="<?php if (count($sales_return) > 0) : echo $sales_return['sales_return_no'];  else : echo $sales_return_no; endif; ?>">
							</div>
						</div>
						<div class="col-md-3">
							<div class="form-group">
								<label for="sales_return_date">Sales Return Date <span style="color:red">*</span></label>
						...
						<div class="col-md-3">
							<div class="form-group">
								...
								<select name="customer_id" id="customer_id" class="form-control select2" data-placeholder="Select Customer">
									<option></option>
