					...
					<div class="col-md-12">
						<div class="col-md-4">
							<div class="form-group">
								...
								<input type="text" name="purchase_no" id="purchase_no" class="form-control" value="<?php if (count($purchase) > 0) : echo $purchase['purchase_no']; else : echo $purchase_no; endif ?>" readonly>
							</div>
						</div>
						<div class="col-md-4">
							<div class="form-group">
						...
						<div class="col-md-4">
							<div class="form-group">
								...
								<select name="supplier_id" id="supplier_id" class="form-control select2" data-placeholder="Select Supplier">
									<option></option>
					...
					<div class="col-md-12">
						...
						<div class="col-md-4">
							<div class="form-group">
								...
								<input type="text" name="quantity" id="quantity" class="form-control required" placeholder="1" onkeyup="validateNumber()">
						...
						<div class="col-md-4">
							<div class="form-group">
								...
								<input type="text" name="price" id="price" class="form-control" placeholder="Price per unit" onkeyup="validatePrice()">
		...
		<div class="modal-content">
			...
			<div class="modal-body">
				<div class="form-group">
					...
					<input type="text" readonly name="code" id="code" value="<?php echo $code; ?>" class="form-control" placeholder="Supplier Code"> Digit Only
				</div>
				<div class="form-group">
