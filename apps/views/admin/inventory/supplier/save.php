    ...
    <div class="box box-primary">
        ...
        <form id="frmSupplier" action="inventory/supplier-save" method="post">
                    ...
                    <div class="col-md-12">
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <input type="text" name="code" id="code" class="form-control" placeholder="Supplier Code" value="<?php if (count($supplier) > 0) : echo $supplier['code']; else : echo $code; endif; ?>" readonly>
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="form-group">
            ...
            <div class="box-footer">
                ...
                <input type="submit" id="supplier_save" class="btn btn-primary pull-right" value="Save Changes">
            </div>
        </form>
    </div>
</section>