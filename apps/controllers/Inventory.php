...
class Inventory extends CI_Controller {
    ...
    {
        $purchase = $this->MPurchase_details->get_total_qty_by_item_id($this->input->post('id'));
        /** Total purchase return quantity */
        $purchase_return = $this->MPurchase_return_details->get_total_qty_by_item_id($this->input->post('id'));

        /** Total sales quantity */
        $sales = $this->MSales_details->get_total_qty_by_item_id($this->input->post('id'));

        /** Total sales return quantity */
        $sales_return = $this->MSales_return_details->get_total_qty_by_item_id($this->input->post('id'));
    ...
    public function sales_table($sales_no)
    {
        ...
        <td class="right"><input type="text" name="DeliveryCharge" id="DeliveryCharge" value=""></td>
        <td></td>
        </tr>
    ...
    public function customer_save($id = NULL)
    {
        if ($this->input->post())
        {
            ...
            {
                $this->form_validation->set_rules('mobile', 'Customer Mobile', 'required');
